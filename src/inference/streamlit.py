...
fluffy_file = f'./fluffy_tmp/fluffy.jpg'
if not os.path.exists(fluffy_file):
    os.makedirs('./fluffy_tmp', exist_ok=True)
    fluffy_file = gdown.download(f'https://drive.google.com/uc?id={FLUFFY}', fluffy_file)
st.image(fluffy_file, use_column_width=True)
st.title('Fluffy')
