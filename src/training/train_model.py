...
The main training script containing all kinds of features.
Core component is a metaflow workflow which contains the following steps:
    1. Train / test and crossval split
    2. Hyperparameter optimization using the crossval data.
    3. Training of final model
"""
